...
def get_model(input_shape=(128, 128, 3), name='UNET_RFF', out_channels=1,
    ...
    level_1 = ConvRFF_block(level_1, deepth=8, name='01',
    ...
    level_2 = ConvRFF_block(
        level_2, deepth=16, kernel_regularizer=k_r, name='02', **kwargs_convRFF)
    ...
    level_3 = ConvRFF_block(
        level_3, deepth=32, kernel_regularizer=k_r, name='03', **kwargs_convRFF)
    ...
    level_4 = ConvRFF_block(
        level_4, deepth=64, kernel_regularizer=k_r, name='04', **kwargs_convRFF)
