...
def get_model(input_shape=(128,128,3), name='b_skips', out_channels=1, mul_dim=1, 
    ...
    level_1 =  DefaultConv2D(8*mul_dim,kernel_initializer=kernel_initializer(3321),kernel_regularizer=k_r,name='Conv01')(level_1)
    ...
    level_2 =  DefaultConv2D(16*mul_dim,kernel_initializer=kernel_initializer(321),kernel_regularizer=k_r,name='Conv02')(level_2)
    ...
    level_3 =  DefaultConv2D(32*mul_dim,kernel_initializer=kernel_initializer(32211),kernel_regularizer=k_r,name='Conv03')(level_3)
    ...
    level_4 =  DefaultConv2D(64*mul_dim,kernel_initializer=kernel_initializer(321),kernel_regularizer=k_r, name='Conv04')(level_4)
