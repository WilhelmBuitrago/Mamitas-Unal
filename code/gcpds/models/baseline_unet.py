...
def unet_baseline(input_shape=(128, 128, 3), name='UNET', out_channels=1, out_ActFunction='sigmoid'):
    ...
    x = DefaultConv2D(
        8, kernel_initializer=kernel_initializer(35), name='Conv90')(x)
    x = layers.BatchNormalization(name='Batch90')(x)
    x = DefaultConv2D(
        8, kernel_initializer=kernel_initializer(7), name='Conv91')(x)
